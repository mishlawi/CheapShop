...
CREATE TABLE IF NOT EXISTS `cheapshop`.`superficie` (
  ...
  `Website` VARCHAR(45) CHARACTER SET 'utf8mb4' NOT NULL,
  PRIMARY KEY (`IDsup`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `cheapshop`.`item` (
  ...
  `Promo` VARCHAR(45) CHARACTER SET 'utf8mb4' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cheapshop`.`user` (
  ...
  `Morada` VARCHAR(45) CHARACTER SET 'utf8mb4' NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cheapshop`.`lista` (
  ...
  PRIMARY KEY (`item_EAN`, `item_superficie_IDsup`, `user_EmailUser`),
